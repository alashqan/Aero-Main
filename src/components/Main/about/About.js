  ...
  return (
    <div className='about_container'>
      ...
      <div className='sub_container'>
        ...
        <p>&emsp;&emsp;&emsp;<span className="gradient-text-background"><strong>Aerophilia</strong></span> is a National level Techno-Cultural fest, conducted for students aspiring to be extraordinary. It’s a 3-day event spanning the weekend with an exciting competition involving <span className="gradient-text-background"><strong>Aeromodelling, Drone race, RC Bot events,</strong></span> and all things out of this world! There are also fun-filled activities and Hackathons. The motive behind organizing such an event is to spread and teach the young talented minds to explore new areas of <span className="gradient-text-background"><strong>technology</strong></span> and <span className="gradient-text-background"><strong>aeromodelling</strong></span> to foster the nation's development.</p>
      ...
      <div className='venue'>
        <p><span className="gradient-text-background">Venue</span> : Sahyadri College of Engineering & Management Managluru.</p>
        <p><span className="gradient-text-background">Schedule</span> : 11, 12 & 13 Nov 2022</p>
      </div>
    </div>
  )
}
